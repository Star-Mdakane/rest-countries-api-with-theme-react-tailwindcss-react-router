  ...
  return (
    <div className='w-screen h-screen text-gray-text dark:text-white dark:bg-blue-bg'>
      <header className='max-w-360 mx-auto w-full h-20 flex items-center justify-between px-4 md:px-10 lg:px-20'>
        <h1 className='text-[14px] md:text-[24px] dark:text-white leading-5 lg:leading-[137.5%] tracking-normal font-extrabold'>
          Where in the world?
        </h1>
        <buttton onClick={toggleTheme} className=" lg:w-27 h-4 lg:h-8">
          {isDark
            ?
      ...
      <div id="seacrh-area" className='max-w-360 mx-auto'>

      </div>
      <div id="country-list" className='max-w-360 mx-auto'>
